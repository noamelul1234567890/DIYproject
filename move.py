...
def all_x_rite(walls, flur_x, coins,walls_level_1,Screen_mode,levels_2):
...
def all_y_up(walls, flur_y, coins,walls_level_1,Screen_mode,levels_2):
    if Screen_mode == 'level 1':
        walls[1].wall_y -= 3
        flur_y -= 3
        walls[0].wall_y -= 3
...
def all_y_down(walls, flur_y, coins,walls_level_1,Screen_mode,levels_2):
    if Screen_mode == 'level 1':
        walls[1].wall_y += 3
        flur_y += 3
        walls[0].wall_y += 3
